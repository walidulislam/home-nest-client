...
import MyPropertiesCard from "../component/MyPropertiesCard";
...
const MyProperties = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://home-nest-server-ashen.vercel.app/my-properties?email=${userEmail}`)
      .then((res) => {
    ...
    return (
      <div className="flex flex-col text-center items-center justify-center h-screen p-10 md:p-20 space-y-4">
        ...
        <p className="text-sm md:text-xl text-[#627382]">
          Please add properties to see them listed here.
        </p>
      </div>
    );
  }
